...
const person3 = {
  ...
  //생성자로 객체 생성하기, 함수 이름이지만 객체를 생성하기 위해서 사용하기 때문에 첫ㅈ가 대문자
          ...
          const person22 = new Person("장원영", 20, "서울시 강남구 역삼동", "아이브")
